...
class TargetWidget extends Widget
{
    ...
    protected function getTargetProgressProvider($tmod,$id,&$defaultOrder)
    {
      if($this->personal)
      {
        ...
        $defaultOrder=['progress' => SORT_DESC, 'weight'=> SORT_ASC, 'name'=>SORT_ASC, 'ip'=>SORT_ASC];
      }
      else
      {
        $targetProgressProvider=new ActiveDataProvider([
        ...
        $defaultOrder=['status'=>SORT_DESC ,'scheduled_at'=>SORT_ASC, 'difficulty' => SORT_ASC,'weight'=> SORT_ASC, 'name' => SORT_ASC, 'ip' => SORT_ASC, ];
      }
