...
class TargetWidget extends Widget
{
  ...
  public $twitter = true;
  public $targetRoute = '/target/default/view';
  public $visibleButtons = null;
  ...
  public function run()
  {
    ...
    if ($this->twitter === false) {
      $this->buttonsTemplate = str_replace('{tweet}', '', $this->buttonsTemplate);
      $this->buttonsTemplate = str_replace('  ', ' ', $this->buttonsTemplate);
    }
