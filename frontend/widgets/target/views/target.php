    ...
    echo GridView::widget([
      ...
      'columns' => [
        ...
        [
          ...
          'value' => function ($model) use ($targetRoute) {
            $append = "";
            ...
            return Html::a(Html::encode($model->name), [$targetRoute, 'id' => $model->id]) . $append;
          }
        ],
        [
        ...
        [
          ...
          'label' => false,
          'value' => function ($model) {
            return $model->approved_writeups === 0 ? '' : '<abbr title="' . \Yii::t('app', 'Writeups are available for this target.') . '"><i class="fas fa-book text-primary" style="font-size: 1.2em;"></i></abbr>';
          },
        ],
        [
        ...
        [
          ...
          'value' => function ($model) {
            return intval($model->rootable) == 0 ? '' : '<abbr title="Rootable"><i class="fa fa-hashtag"></i></abbr>';
          },
        ],
        [
          ...
          'value' => function ($model) {
            return sprintf('<i class="fas fa-fingerprint"></i> %d<small>/%d</small>', $model->total_findings, $model->player_findings);
          },
        ],
        [
          ...
          'value' => function ($model) {
            return sprintf('<i class="fas fa-flag"></i> %d<small>/%d</small>', $model->total_treasures, $model->player_treasures);
          },
        ],
        [
