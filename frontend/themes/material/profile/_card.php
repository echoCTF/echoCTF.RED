...
<div class="card card-profile">
  ...
  <?php endif;?>
          ...
          <li class="nav-item text-left"><strong><i class="fas fa-child"></i> <?=Html::a("Invites", ['profile/invite', 'id'=>$profile->id])?></strong> <span class="pull-right"><?=$profile->invitesCount?></span></li>
