    ...
    <div class="card-body">
      ...
      <?php if(!$model->answered):?>
        <?php $form=ActiveForm::begin([
          ...
          <?=$form->field($answer, 'answer')->textInput(['placeholder'=>$model->maskedCode,'autofocus' => false, 'autocomplete'=>'off', 'style'=>"width: 100%;margin: 0; padding: 0; border: 0;",'id'=>'question'.$model->id,'maxlength'=>256])->label(false) ?>
          <?php ActiveForm::end();?>
      <?php endif;?>
    </div>
  </div>
