...
<div class="leader" >
    ...
    <div class="leader-wrap">
      ...
      <div class="leader-name" style="width: 100%"><?=$model->player->profile->link?> <?=\Yii::t('app','on')?> <?=Html::a($model->target->name.' / '.long2ip($model->target->ip),['/target/default/versus','id'=>$model->target_id,'profile_id'=>$model->player->profile->id]);?></div>
