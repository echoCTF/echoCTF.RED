  ...
  ",
          ...
          <div class="col">
            <div class="row">
              ...
              <div class="col"><?= $form->field($model, 'inviteonly')->checkbox([
                                  'label' => 'Invite Only <span data-toggle="tooltip" title="Allow players with invites only to join." style="cursor: help;">❓</span>',
                                  'encode' => false, // Allow HTML in label
                                ]) ?></div>
              <div class="col"><?= $form->field($model, 'locked')->checkbox([
                                  'label' => 'Lock <span data-toggle="tooltip" title="Lock team so no other players can join" style="cursor: help;">❓</span>',
                                  'encode' => false, // Allow HTML in label
                                ]) ?></div>
            </div>
