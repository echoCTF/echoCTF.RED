...
//        'js/plugins/bootstrap-selectpicker.min.js', // XXX FIXME MOVE REGISTER TO profile/settings
        ...
        '/js/plugins/arrive.min.js?v=0.0.1',
        /* Chartist JS */
        //'js/plugins/chartist.min.js',
        /*  Notifications Plugin    */
        'js/plugins/bootstrap-notify.min.js?v=0.0.1',
        ...
        '/js/material-dashboard.js?v=0.0.3',
        '/js/libechoctf.js?v=0.0.4',
        // 'js/superfish.js'
    ];
    public $depends=[
        'yii\web\YiiAsset',
