...
class MaterialAsset extends AssetBundle
{
    ...
    public $css=[
        ...
        ['css/all.min.css?v=0.19.0', 'defer'=>'defer'],
        'css/material-dashboard.css?v=0.19.0',
        'css/material.css?v=0.19.0',
    ];

    public $js=[
        '/js/core/popper.min.js?v=0.19.0',
        '/js/core/bootstrap-material-design.min.js?v=0.19.0',
        '/js/plugins/perfect-scrollbar.jquery.min.js?v=0.19.0',
...
//        'js/plugins/bootstrap-selectpicker.min.js', // XXX FIXME MOVE REGISTER TO profile/settings
        ...
        '/js/plugins/arrive.min.js?v=0.19.0',
        /* Chartist JS */
        //'js/plugins/chartist.min.js',
        /*  Notifications Plugin    */
        'js/plugins/bootstrap-notify.min.js?v=0.19.0',
        ...
        '/js/material-dashboard.js?v=0.19.0',
        '/js/libechoctf.js?v=0.19.0',
        // 'js/superfish.js'
    ];
    public $depends=[
        'yii\web\YiiAsset',
