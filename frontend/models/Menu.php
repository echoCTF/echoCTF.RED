            ...
            [
              ...
              'linkTemplate'=>'<a href="{url}" class="nav-link">{icon} {label}</a>',
                ...
                [
                    ...
                    ['label' => \Yii::t('app','Speed Programming'), 'icon'=>'<i class="fas fa-laptop-code"></i>','url' => ['/speedprogramming/default/index'],'visible'=>!Yii::$app->user->isGuest && Yii::$app->DisabledRoute->enabled('speed/default/index')  && !\Yii::$app->sys->module_speedprogramming_disabled,'active'=>\Yii::$app->controller->module->id=="speedprogramming"],
