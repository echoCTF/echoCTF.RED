            ...
            [
              ...
              'linkTemplate'=>'<a href="{url}" class="nav-link">{icon} {label}</a>',
                ...
                [
                    ...
                    ['label' => 'Subscriptions', 'icon'=>'<img src="/images/vip.svg" style="max-width: 28px">','url' => ['/subscription/default/index'],'visible'=>!Yii::$app->user->isGuest && Yii::$app->DisabledRoute->enabled('subscription/default/index') && \Yii::$app->sys->subscriptions_menu_show===true,'active'=>\Yii::$app->controller->module->id=="subscription"],
                    ...
                    ['label' => 'Help', 'icon'=>'help','url' => ['/help/default/index'],'visible'=>Yii::$app->DisabledRoute->enabled('help/default/index'),'active'=>\Yii::$app->controller->module->id=="help"],
