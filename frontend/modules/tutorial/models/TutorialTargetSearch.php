...
use app\modules\tutorial\models\TutorialTarget;

/**
 * TutorialTargetSearch represents the model behind the search form of `app\modules\tutorial\models\TutorialTarget`.
 */
