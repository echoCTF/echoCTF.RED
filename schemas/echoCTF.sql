...
CREATE TABLE `achievement` (
  ...
  `pubname` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Name for the public eyes',
  `description` text COLLATE utf8_unicode_ci,
  `pubdescription` text COLLATE utf8_unicode_ci COMMENT 'Description for the public eyes',
  `points` decimal(10,2) DEFAULT NULL,
  `player_type` enum('offense','defense') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'offense',
  `appears` int(11) DEFAULT '0',
  `effects` enum('users_id','team','total') COLLATE utf8_unicode_ci DEFAULT 'users_id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='What treasures are needed to get this badge';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `challenge` (
  ...
  `difficulty` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'moderate',
  `description` longtext COLLATE utf8_unicode_ci,
  `player_type` enum('offense','defense') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'offense',
  `filename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'The filename that will be provided to participants',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
...
CREATE TABLE `country` (
  `id` varchar(12) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `credential` (
  ...
  `pubtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Credentials that participants can discover and claim points.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `crl` (
  ...
  `crt` text COLLATE utf8_unicode_ci,
  `txtcrt` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `disabled_route` (
  ...
  PRIMARY KEY (`route`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Disabled controller actions for pUI';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `finding` (
  ...
  `protocol` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `hint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `player_type` enum('offense','defense','both') COLLATE utf8_unicode_ci DEFAULT NULL,
  `message` text COLLATE utf8_unicode_ci,
  `category` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'easy_points',
...
CREATE TABLE `infrastructure` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Infrastructure elements';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Infrastructure/Target association';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Player level standings';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `muisess` (
  ...
  `data` blob,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='mUI Sessions table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `objective` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `title` (`title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The objectives for the game based on player type';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player` (
  ...
  `type` enum('offense','defense') COLLATE utf8_unicode_ci DEFAULT 'offense',
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'password',
  `activkey` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The badges each user will get to see';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The user findings each user will get to see';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The hints each user will get to see';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `player_ssl` (
  ...
  `txtcrt` text COLLATE utf8_unicode_ci NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Player SSL Keys';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The treasures each user will get to see';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `profile` (
  ...
  `player_id` int(11) unsigned NOT NULL,
  `visibility` enum('public','private','ingame') COLLATE utf8_unicode_ci DEFAULT 'private',
  `bio` text COLLATE utf8_unicode_ci,
  `country` varchar(3) COLLATE utf8_unicode_ci DEFAULT 'UNK' COMMENT 'Country code (eg GR)',
  `avatar` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'default.png' COMMENT 'Profile avatar',
  `discord` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Discord handle (eg  @username#1234)',
  `twitter` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Twitter handle (eg @echoCTF)',
  `github` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Github handle (eg echoCTF)',
  `htb` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'HTB Profile (eg 47396)',
...
CREATE TABLE `report` (
  ...
  `status` enum('pending','invalid','approved') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'pending',
  `points` int(11) NOT NULL DEFAULT '0',
  `modcomment` longtext COLLATE utf8_unicode_ci COMMENT 'The comment from the moderator about the report',
  `pubtitle` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pubbody` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `player_id` (`player_id`),
...
CREATE TABLE `stream` (
  ...
  `message` text COLLATE utf8_unicode_ci,
  `pubtitle` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `pubmessage` text COLLATE utf8_unicode_ci,
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `player_id` (`player_id`),
...
CREATE TABLE `sysconfig` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Very simple table keeping single key/val pairs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `target` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'A name for the target',
  `fqdn` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'The FQDN for the target',
  `purpose` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'The purpose of this target',
  `description` text COLLATE utf8_unicode_ci,
  `ip` int(10) unsigned NOT NULL COMMENT 'The IP of the target',
  `mac` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'The mac associated with this IP',
  `active` tinyint(1) DEFAULT '1',
  `status` varchar(32) COLLATE utf8_unicode_ci DEFAULT 'offline',
  `scheduled_at` datetime DEFAULT NULL,
  `net` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Network this pod is attached',
  `server` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Docker Server connection string.',
...
CREATE TABLE `target_variable` (
  ...
  `key` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Variable key (aka name)',
  `val` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Variable value',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Docker variables';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `target_volume` (
  ...
  `volume` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Volume on host to map',
  `bind` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Bind to path within pod',
  `ts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `treasure` (
  ...
  `points` decimal(10,2) DEFAULT NULL,
  `player_type` enum('offense','defense') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'offense',
  `csum` varchar(128) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT 'If there is a file attached to this treasure',
  `appears` int(11) DEFAULT '0',
  `effects` enum('player','team','total') COLLATE utf8_unicode_ci DEFAULT 'player',
