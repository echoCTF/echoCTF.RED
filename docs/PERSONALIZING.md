...
* `_targetname.png` 220x300px used by the `view` and `versus` pages
* `_targetname-thumbnail.png` 110x150px used on target listing widgets
* `targetname.png` used for social media posts and it is usually generated by the application
