...
class Produce extends Component
{
   ...
   */
  static public function dockernames()
  {
    return self::$leftpart[array_rand(self::$leftpart)].self::$rightpart[array_rand(self::$rightpart)];
  }
}
