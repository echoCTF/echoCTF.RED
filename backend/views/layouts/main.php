...
//                ['label' => 'Player Tutorial Task', 'url' => ['/activity/player-tutorial-task'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin ,],
            ...
            ['label' => '<span class="glyphicon glyphicon-flag"></span> Gameplay', 'url' => ['/gameplay'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin,
              'items'=> [
                ...
                ['label' => 'Tutorial Target', 'url' => ['/gameplay/tutorial-target'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin, ],
                ['label' => 'Tutorial Tasks', 'url' => ['/gameplay/tutorial-task'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin, ],
                ['label' => 'Tutorial Task Dependencies', 'url' => ['/gameplay/tutorial-task-dependency'], 'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin, ],
              ],
            ],
