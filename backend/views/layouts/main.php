    ...
    echo Nav::widget([
      ...
      'items' => [
        ...
        [
          ...
          'icon' => 'fas fa-money-check-alt',
          'active' => Yii::$app->controller->module->id == 'sales',
          'visible' => array_key_exists('sales', \Yii::$app->modules) !== false && Yii::$app->sys->subscriptions_menu_show === true && !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin,
          'items' => [
        ...
        [
          ...
          'active' => Yii::$app->controller->module->id == 'activity',
          'items' => [
        ...
        [
          ...
          'visible' => !Yii::$app->user->isGuest && !Yii::$app->sys->module_smartcity_disabled,
          'active' => Yii::$app->controller->module->id == 'smartcity',
          'items' => [
        ...
        [
          ...
          'items' => [
            ...
            ['label' => 'Team Invites', 'url' => ['/frontend/team-invite/index'], 'visible' => !Yii::$app->user->isGuest,],
        ...
        [
          ...
          'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin,
          'active' => Yii::$app->controller->module->id == 'infrastructure',
          'items' => [
        ...
        [
          ...
          'url' => ['/gameplay'],
          'visible' => !Yii::$app->user->isGuest && Yii::$app->user->identity->isAdmin,
          'active' => Yii::$app->controller->module->id == 'gameplay',
          'items' => [
