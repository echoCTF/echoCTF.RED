...
/**
 * Class m200309_081940_populate_countries
 */
class m200309_081940_populate_countries extends Migration
{
    /**
     * {@inheritdoc}
     */
...
INSERT INTO country VALUES ('AF','Afghanistan'),
      ...
      ('FI','Finland'),('FR','France'),('FX','France, Metropolitan'),
      ('GF','French Guiana'),('PF','French Polynesia'),('TF','French Southern Territories'),
      ('GA','Gabon'),('GM','Gambia'),('GE','Georgia'),('DE','Germany'),('GH','Ghana'),
      ('GI','Gibraltar'),('GR','Greece'),('GL','Greenland'),('GD','Grenada'),
      ('GP','Guadeloupe'),('GU','Guam'),('GT','Guatemala'),('GK','Guernsey'),
      ...
      ('MK','Republic of North Macedonia'),('MG','Madagascar'),
      ...
      ('SA','Saudi Arabia'),('SN','Senegal'),('RS','Serbia'),('CS','Serbia and Montenegro'),
...
";
    ...
    {
        $this->db->createCommand("TRUNCATE country")->execute();
