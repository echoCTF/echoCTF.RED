...
class Abuser extends \yii\db\ActiveRecord
{
  public $created_at_ago,$updated_at_ago;
    ...
    public function getFormatted(){
      ...
      {
        return sprintf('%s produced %s generated by [%s] for model [%s] with id [%d], <abbr title="%s">%s</abbr>',$this->title,$this->reason,$this->model,$this->model_id,$this->created_at,$this->created_at_ago);
      }
