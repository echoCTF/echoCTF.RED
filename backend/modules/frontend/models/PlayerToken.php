...
class PlayerToken extends \yii\db\ActiveRecord
{
  ...
  {
    return [
      ['token', 'default', 'value' => Yii::$app->security->generateRandomString(20)],
      ['description', 'default', 'skipOnEmpty'=>false, 'skipOnError'=>false,'value' => 'auto-generated by backend'],
      [['expires_at', 'created_at'], 'default', 'value' => \Yii::$app->formatter->asDatetime(new \DateTime('NOW + 30 days'), 'php:Y-m-d H:i:s')],
