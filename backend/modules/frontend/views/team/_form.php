...
<div class="team-form">
    ...
    <?= $form->field($model, 'owner_id')->dropDownList(ArrayHelper::map(Player::find()->all(),'id','username'),['prompt'=>'Select the owner for team'])->Label('Owner')->hint('Choose the player who will be the owner of the team')?>
