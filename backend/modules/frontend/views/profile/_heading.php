      ...
      <div class="media-body va-m">
        ...
        <div class="media-links">
          ...
          <?php if ($model->owner->stripe_customer_id):?>
            <li>
              <?=Html::a('<span class="fab fa-stripe fs-2 text-info"></span>', "https://dashboard.stripe.com/customers/" . $model->owner->stripe_customer_id, ['target' => '_blank','title'=>'Go to stripe customer']);?>
            </li>
          <?php endif;?>
