<div class="row">
    <div class="dropdown">
      ...
      $player_actions = [
        ...
        [
          'label' => 'Set Delete status for player',
          'url' => ['player/set-deleted', 'id' => $model->player_id],
          'linkOptions' => [
            'data' => [
        ...
        [
          'label' => 'Delete player',
          'url' => ['player/delete', 'id' => $model->player_id],
          'linkOptions' => [
            'data' => [
        ...
        [
          'label' => 'Reset auth_key',
          'url' => ['player/reset-authkey', 'id' => $model->player_id],
          'linkOptions' => [
            'class' => 'text-danger',
      ...
      if (\Yii::$app->sys->player_require_approval === true) {
        if ($model->owner->approval == 0 || $model->owner->approval == 3) {
          $player_actions[] =  [
            ...
            'url' => ['player/approve', 'id' => $model->player_id],
            'linkOptions' => [
              'data' => [
        ...
        if ($model->owner->approval == 0 || $model->owner->approval == 1) {
          $player_actions[] =  [
            'label' => 'Reject Player',
            'url' => ['player/reject', 'id' => $model->player_id],
            'linkOptions' => [
              'data' => [
