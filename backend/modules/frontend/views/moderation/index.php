...
$this->title = ucfirst(Yii::$app->controller->module->id) . ' / ' . ucfirst(Yii::$app->controller->id) . '/ Writeup Hoarders';
...
<div class="player-index">
  ...
  <h1>Moderation: Writeups hoarding</h1>
  <p>Accounts with 0 points that have activated writeups.</p>
  ...
  <?= GridView::widget([
    ...
    'columns' => [
      ...
      'online:boolean',
      [
        'attribute' => 'player_target_help_count',
        'label' => 'Activated Writeups',
        'value'=>function($model) {return $model->player_target_help_count;}
      ],
      //'active:boolean',
      [
        'attribute' => 'academic',
      ...
      [
        ...
        'buttons' => [
          ...
          'delete' => function ($url, $model) {
            return Html::a('<i class="bi bi-trash3-fill"></i>', ['/frontend/player/delete', 'id' => $model->id], [
              'class' => '',
