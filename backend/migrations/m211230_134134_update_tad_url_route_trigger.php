...
/**
 * Class m211230_134134_update_tad_url_route_trigger
 */
class m211230_134134_update_tad_url_route_trigger extends Migration
{
  public $DROP_SQL="DROP TRIGGER IF EXISTS {{%tad_url_route}}";
  public $CREATE_SQL="CREATE TRIGGER {{%tad_url_route}} AFTER DELETE ON {{%url_route}} FOR EACH ROW
  thisBegin:BEGIN
