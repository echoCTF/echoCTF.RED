...
class m260827_204704_add_points_and_resolved_column_to_abuser_table extends Migration
{
  ...
  {
    $this->addColumn('abuser', 'points', $this->integer()->notNull()->defaultValue(0)->after('model_id'));
    $this->addColumn('abuser', 'resolved', $this->boolean()->notNull()->defaultValue(0)->after('points'));
  }
