...
/**
 * Class m191007_124541_create_tai_player_trigger
 */
class m191007_124541_create_tai_player_trigger extends Migration
{
  public $DROP_SQL="DROP TRIGGER IF EXISTS {{%tai_player}}";
    ...
    {
        echo "m191007_124541_create_tai_player_trigger cannot be reverted.\n";
...
BEGIN
  ...
  IF @teams=false THEN
    INSERT INTO player_score values (NEW.id, 0) ON DUPLICATE KEY UPDATE points=values(points);
  END IF;
