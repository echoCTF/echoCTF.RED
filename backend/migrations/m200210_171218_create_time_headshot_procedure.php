...
/**
 * Class m200210_171218_create_time_headshot_procedure
 */
class m200210_171218_create_time_headshot_procedure extends Migration
{
  public $DROP_SQL="DROP PROCEDURE IF EXISTS {{%time_headshot}}";
  public $CREATE_SQL="CREATE PROCEDURE {{%time_headshot}} (IN pid INT, IN tid INT)
  BEGIN
